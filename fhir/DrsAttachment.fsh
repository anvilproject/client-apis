...
// adds DRSMeta to Attachment
* extension contains DRSMeta named drs_meta 1..1 and 
...
Id: drs-meta
Title: "DRS meta"
Description: "The drs meta object"
* extension contains
    id 1..1 MS and
    name 0..1 and
    self_uri 1..1 MS and
    ...
    version 0..1 and
    mime_type 0..1 
* extension[id] ^short = "An identifier unique to this `DRSMeta`."
* extension[id].value[x] only string
* extension[name] ^short = "A string that can be used to name a `DRSMeta`."
...
* extension[size].value[x] only decimal
...
* extension[mime_type] ^short = "A string providing the mime-type of the `DRSMeta`."
...
Id: drs-checksum
Title: "DRS Checksum"
Description: "The checksum of the `DRSMeta`. At least one checksum must be provided."    
* extension contains
    checksum 1..1 MS and
    type 1..1 MS
...
Description: "The list of access methods that can be used to fetch the repository object."    
* extension contains
    type 1..1 MS and
    access_url 0..1 and
    access_id 0..1 and
...
* extension[drs_meta].extension[id].valueString = "any-id"
* extension[drs_meta].extension[name].valueString = "any-file-name"
* extension[drs_meta].extension[self_uri].valueString = "drs://url-here"
* extension[drs_meta].extension[created_time].valueDateTime = "1985-04-12T23:20:50.52Z"
* extension[drs_meta].extension[updated_time].valueDateTime = "1985-04-12T23:20:50.52Z"
* extension[drs_meta].extension[size].valueDecimal = 17734638122
* extension[drs_meta].extension[version].valueString = "0.0.0"
* extension[drs_meta].extension[mime_type].valueString = "application/json"
* extension[checksums].extension[checksum].valueString = "abcdef0123456789"
* extension[checksums].extension[type].valueString = "etag"
* extension[access_methods].extension[type].valueString = "s3"
* extension[access_methods].extension[access_url].valueString = "s3://some-url-here"
* extension[access_methods].extension[region].valueString = "us-west"
